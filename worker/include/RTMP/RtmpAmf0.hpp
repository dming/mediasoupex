#ifndef MS_RTMP_AMF0_HPP
#define MS_RTMP_AMF0_HPP
...
namespace RTMP
{
	...
	/*
	 ...
	 1. the bytes proxy: RtmpBuffer
	 // when we got some bytes from file or network,
	 // use RtmpBuffer proxy to read/write bytes
	...
	public:
		 ...
		 */
		virtual srs_error_t read(Utils::RtmpBuffer* stream) = 0;
		/**
		 * write AMF0 instance to stream.
		 */
		virtual srs_error_t write(Utils::RtmpBuffer* stream) = 0;
		/**
	 ...
	 */
	extern srs_error_t srs_amf0_read_string(Utils::RtmpBuffer* stream, std::string& value);
	extern srs_error_t srs_amf0_write_string(Utils::RtmpBuffer* stream, std::string value);
	 ...
	 */
	extern srs_error_t srs_amf0_read_boolean(Utils::RtmpBuffer* stream, bool& value);
	extern srs_error_t srs_amf0_write_boolean(Utils::RtmpBuffer* stream, bool value);
	 ...
	 */
	extern srs_error_t srs_amf0_read_number(Utils::RtmpBuffer* stream, double& value);
	extern srs_error_t srs_amf0_write_number(Utils::RtmpBuffer* stream, double value);
	 ...
	 */
	extern srs_error_t srs_amf0_read_null(Utils::RtmpBuffer* stream);
	extern srs_error_t srs_amf0_write_null(Utils::RtmpBuffer* stream);
	 ...
	 */
	extern srs_error_t srs_amf0_read_undefined(Utils::RtmpBuffer* stream);
	extern srs_error_t srs_amf0_write_undefined(Utils::RtmpBuffer* stream);
	...
	namespace srs_internal
	{
		 ...
		 */
		extern srs_error_t srs_amf0_read_utf8(Utils::RtmpBuffer* stream, std::string& value);
