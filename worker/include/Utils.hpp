...
namespace Utils
{
	...
	public:
		...
		static uint32_t ReadUint32BE(char* data)
		{
		...
		static uint32_t ReadUint32LE(char* data)
		{
			uint8_t* p     = (uint8_t*)data;
		...
		static uint32_t ReadUint24BE(char* data)
		{
			uint8_t* p     = (uint8_t*)data;
		...
		static uint32_t ReadUint24LE(char* data)
		{
			uint8_t* p     = (uint8_t*)data;
		...
		static uint16_t ReadUint16BE(char* data)
		{
			uint8_t* p     = (uint8_t*)data;
		...
		static uint16_t ReadUint16LE(char* data)
		{
			uint8_t* p     = (uint8_t*)data;
		...
		static void WriteUint32BE(char* p, uint32_t value)
		{
			p[0] = value >> 24;
			p[1] = value >> 16;
			p[2] = value >> 8;
		...
		static void WriteUint32LE(char* p, uint32_t value)
		{
			p[0] = value & 0xff;
			p[1] = value >> 8;
			p[2] = value >> 16;
		...
		static void WriteUint24BE(char* p, uint32_t value)
		{
			p[0] = value >> 16;
			p[1] = value >> 8;
			p[2] = value & 0xff;
		...
		static void WriteUint24LE(char* p, uint32_t value)
		{
			p[0] = value & 0xff;
			p[1] = value >> 8;
			p[2] = value >> 16;
		...
		static void WriteUint16BE(char* p, uint16_t value)
		{
			p[0] = value >> 8;
			p[1] = value & 0xff;
		}

		static void WriteUint16LE(char* p, uint16_t value)
		{
			p[0] = value & 0xff;
			p[1] = value >> 8;
		}
